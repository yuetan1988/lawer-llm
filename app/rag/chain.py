...
class KnowledgeCenter:
    ...
    def __init__(self, CFG, loader, spliter, embedder):
        self.CFG = CFG
        self.loader = loader
    ...
    def init_vector_db(self, filepath: str):
        document = self.loader(file_path).load_and_split(self.spliter)
        vector_db = Chroma.from_documents(documents=doc, embedding=self.embedder, persist_directory=self.CFG.persist_directory)
        vector_db.persist()
...
if __name__ == "__main__":
    ...
    knowledge_center.init_vector_db()
